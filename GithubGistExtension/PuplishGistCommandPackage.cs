//------------------------------------------------------------------------------
// <copyright file="PuplishGistCommandPackage.cs" company="Company">
...
namespace GithubGistExtension
{
    ...
    public sealed class PuplishGistCommandPackage : Package
    {
        ...
        /// </summary>
        public const string PackageGuidString = "769b8fb2-bff9-41da-b4f2-8445e8d4398a";

        /// <summary>
        /// Initializes a new instance of the <see cref="PuplishGistCommand"/> class.
        /// </summary>
        public PuplishGistCommandPackage()
        {
